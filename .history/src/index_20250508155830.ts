...
// API Routes
app.get('/api/test-connection', async (req: Request, res: Response, next: NextFunction) => {
  try {
...
// Update todo status
app.put('/api/todos/:id', async (req: Request<{ id: string }>, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
// Delete todo
app.delete('/api/todos/:id', async (req: Request<{ id: string }, any, any>, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
