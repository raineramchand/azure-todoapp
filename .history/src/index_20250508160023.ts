...
// Helper function to properly type async route handlers
...
// Update todo status
app.put('/api/todos/:id', asyncHandler(async (req: Request<{ id: string }>, res) => {
  const { id } = req.params;
...
// Delete todo
app.delete('/api/todos/:id', asyncHandler(async (req: Request<{ id: string }>, res) => {
  const { id } = req.params;
